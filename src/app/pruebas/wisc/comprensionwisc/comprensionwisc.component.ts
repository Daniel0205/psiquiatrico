...
export class ComprensionwiscComponent implements OnInit {
  ...
  general:String[] = ["General: Reconocimiento de que cepillarse los dientes los limpia; previene el deterioro, enfermedad, caries y otros problemas dentales; o mejora la apariencia",
                      "General: Reconocimiento de que las verduras son parte de una dieta nutritiva y son necesarias para la salud apropiada, la energía, la fortaleza o el crecimiento",
                      "General: Reconocimiento de que los cinturones sirven como precaución de seguridad, para proteger a las personas o para detenerlas en su asiento durante un accidente",
                      "General: Indicación clara de que el uniforme es un medio para identificar con facilidad y rápidamente a una persona como oficial de policía. Para mostrar quién tiene la autoridad de imponer la ley",
                      "General: Intentar regresarla a su dueño, ya sea buscando una identificación del propietario y regresandola o, entregandola  al dueño de la tienda o a un policía",
                      ...
                      "General: Refleja una conciencia sobre la importancia de los inspectores de carne para el público en general (es decir, que mucha gente está protegida por ellos o se vería afectada de manera adversa si no existiera)",
                      "General: Reconocimiento de que el ejercicio es bueno para el cuerpo al aumentar la salud, la capacidad física y cardiovascular",
                      "General: Para conservar una amistad al admitir tu cula e intentar que la otra persona se sienta mejor al tener consciencia de tu pena y de que buscas perdón",
                      ...
                      "General: Reconocimiento de que los derechos de autor y patentes proporcionan protección legal y dan el crédito apropiado a la propiedad intelectual",
                      "General: Reconocimiento de que una promesa es una base para la fe y confianza mutuas, y tiene — una ventaja mutua o recíproca; Reconocimiento de que una promesa tiene el estatus de un contrato implícito",
                      ...
                      "General: reconocimiento de que la compra de una estampilla paga el costo de envío de una carta que es posible que ésta no pueda enviarse sin una estampilla (incluso si el niño no expresa específicamente que la estampilla paga los costos de envío)",
